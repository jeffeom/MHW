...
class ContactUsViewController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    if (currentLang?.contains("ko") ?? false) {
      ...
      helpAttributedString.addAttribute(.font, value: UIFont(name: "Avenir-Heavy", size: 13.0)!, range: NSRange(location: 29, length: 20))
      helpAttributedString.addAttribute(.foregroundColor, value: UIColor(red: 0, green: 164/255, blue: 255/255, alpha: 1.0), range: NSRange(location: 29, length: 20))
